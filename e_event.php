...
class enquiry_event // plugin-folder + '_event'
{
	...
	function config()
	{
		...
		$event[] = array(
			'name'	=> "postenquiry", // when this is triggered... (see http://e107.org/developer-manual/classes-and-methods#events)
			'function'	=> "postenquiry", // ..run this function (see below).
		);
	...
	function postenquiry($data) // the method to run.
	{
		print_a($data);
	}
