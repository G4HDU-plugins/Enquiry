...
class plugin_enquiry_admin_ui extends e_admin_ui
{
    ...
    protected $prefs = array(
        'pref_conname' => array(
            ...
            'type' => 'text',
            'data' => 'str',
            'help'=>'Name of person to contact',
            'tab' => 0,
            'validate' => false),
        'pref_conphone' => array(
            ...
            'type' => 'text',
            'data' => 'str',
            'help' => 'Phone number of contact',
            'tab' => 0),
        'pref_emailname' => array(
            'title' => LAN_PLUGIN_ENQUIRY_ADMIN_CONENAME,
            'type' => 'text',
            'data' => 'str',
            'help' => 'Name of person email is from',
            'tab' => 0),
        ...
        'pref_use_captcha' => array(
            ...
            'type' => 'boolean',
            'data' => 'int',
            'help' => 'Use capture for guests',
            'tab' => 0),
        'pref_captcha_colour' => array(
            'title' => LAN_PLUGIN_ENQUIRY_ADMIN_CAPTURECOLOUR,
            'type' => 'text',
            'data' => 'str',
            'help'=>'Leave blank for site default',
            'note'=>'Overide site default',
            'tab' => 0),
