...
class plugin_enquiry_admin_ui extends e_admin_ui
{
    ...
    protected $fields = array(
        ...
        'enquiry_title' => array(
            ...
            //'primary' => true,
            'writeParms' => array(
                '1' => LAN_PLUGIN_ENQUIRY_ADMIN_MR,
                '2' => LAN_PLUGIN_ENQUIRY_ADMIN_MRS,
                '3' => LAN_PLUGIN_ENQUIRY_ADMIN_MISS,
                '4' => LAN_PLUGIN_ENQUIRY_ADMIN_MS,
                '5' => LAN_PLUGIN_ENQUIRY_ADMIN_MX)),
        'enquiry_name' => array(
        ...
        'enquiry_postcode' => array(
            ...
            'thclass' => ''),
        'enquiry_phone' => array(
            'title' => LAN_PLUGIN_ENQUIRY_ADMIN_PHONE,
            'type' => 'text',
            'data' => 'str',
            'width' => 'auto',
            'thclass' => ''),
    ...
    protected $prefs = array(
        'pref_conname' => array(
            ...
            'type' => 'text',
            'data' => 'str',
            'help'=>LAN_PLUGIN_ENQUIRY_ADMIN_HELP_CONTACT,
            'tab' => 0,
            'validate' => false),
        'pref_conphone' => array(
        ...
        'pref_use_captcha' => array(
            ...
            'type' => 'boolean',
            'data' => 'int',
            'help' =>LAN_PLUGIN_ENQUIRY_ADMIN_HELP_CAPTCHA,
            'tab' => 0),
        'pref_captcha_colour' => array(
            'title' => LAN_PLUGIN_ENQUIRY_ADMIN_CAPTURECOLOUR,
            'type' => 'text',
            'data' => 'str',
